...
func PkgVersion() (semver.Version, error) {
	...
	re := regexp.MustCompile("^.*/pulumi-flyio/sdk(/v\\d+)?")
...
func PkgResourceDefaultOpts(opts []pulumi.ResourceOption) []pulumi.ResourceOption {
	...
	defaults = append(defaults, pulumi.PluginDownloadURL("https://github.com/lukeshay/pulumi-flyio/releases/download/0.0.21+dirty"))
	version := semver.MustParse("0.0.21+dirty")

...
namespace Pulumi.Flyio
{
    static class Utilities
    {
        ...
        public static global::Pulumi.InvokeOptions WithDefaults(this global::Pulumi.InvokeOptions? src)
        {
            ...
            dst.PluginDownloadURL = src?.PluginDownloadURL ?? "https://github.com/lukeshay/pulumi-flyio/releases/download/0.0.18+dirty";
            return dst;
        }
        ...
        static Utilities()
        {
            ...
            using var stream = assembly.GetManifestResourceStream("Pulumi.Flyio.version.txt");
    ...
    internal sealed class FlyioResourceTypeAttribute : global::Pulumi.ResourceTypeAttribute
    {
        public FlyioResourceTypeAttribute(string type) : base(type, Utilities.Version)
        {
        }
    }
}

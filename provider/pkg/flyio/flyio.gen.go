...
// CreateOIDCTokenRequest defines model for CreateOIDCTokenRequest.
...
type CreateVolumeRequest struct {
	...
	MachinesOnly      *bool            `json:"machines_only,omitempty" pulumi:"machinesOnly,optional"`
	Name              *string          `json:"name,omitempty" pulumi:"name,optional"`
	Region            *string          `json:"region,omitempty" pulumi:"region,optional"`
...
type FlyMachineService struct {
	...
	Autostop                 *bool                         `json:"autostop,omitempty" pulumi:"autostop,optional"`
...
type MachinesWaitParams struct {
	// InstanceId instance? version? TODO
...
// MachinesGetOIDCTokenJSONRequestBody defines body for MachinesGetOIDCToken for application/json ContentType.
type MachinesGetOIDCTokenJSONRequestBody = CreateOIDCTokenRequest
...
type ClientInterface interface {
	...
	// VolumesList request
	VolumesList(ctx context.Context, appName string, reqEditors ...RequestEditorFn) (*http.Response, error)
	...
	// MachinesGetOIDCTokenWithBody request with any body
	MachinesGetOIDCTokenWithBody(ctx context.Context, contentType string, body io.Reader, reqEditors ...RequestEditorFn) (*http.Response, error)

	MachinesGetOIDCToken(ctx context.Context, body MachinesGetOIDCTokenJSONRequestBody, reqEditors ...RequestEditorFn) (*http.Response, error)
}
...
func (c *Client) VolumesList(ctx context.Context, appName string, reqEditors ...RequestEditorFn) (*http.Response, error) {
	req, err := NewVolumesListRequest(c.Server, appName)
	if err != nil {
		return nil, err
	}
	req = req.WithContext(ctx)
...
func (c *Client) MachinesGetOIDCTokenWithBody(ctx context.Context, contentType string, body io.Reader, reqEditors ...RequestEditorFn) (*http.Response, error) {
	req, err := NewMachinesGetOIDCTokenRequestWithBody(c.Server, contentType, body)
	if err != nil {
		return nil, err
	}
	req = req.WithContext(ctx)
...
func (c *Client) MachinesGetOIDCToken(ctx context.Context, body MachinesGetOIDCTokenJSONRequestBody, reqEditors ...RequestEditorFn) (*http.Response, error) {
	req, err := NewMachinesGetOIDCTokenRequest(c.Server, body)
	if err != nil {
		return nil, err
	}
	req = req.WithContext(ctx)
...
func NewVolumesListRequest(server string, appName string) (*http.Request, error) {
	var err error
...
// NewMachinesGetOIDCTokenRequest calls the generic MachinesGetOIDCToken builder with application/json body
func NewMachinesGetOIDCTokenRequest(server string, body MachinesGetOIDCTokenJSONRequestBody) (*http.Request, error) {
	var bodyReader io.Reader
	buf, err := json.Marshal(body)
	if err != nil {
		return nil, err
	...
	bodyReader = bytes.NewReader(buf)
	return NewMachinesGetOIDCTokenRequestWithBody(server, "application/json", bodyReader)
}

// NewMachinesGetOIDCTokenRequestWithBody generates requests for MachinesGetOIDCToken with any type of body
func NewMachinesGetOIDCTokenRequestWithBody(server string, contentType string, body io.Reader) (*http.Request, error) {
	var err error
	...
	operationPath := fmt.Sprintf("/v1/tokens/oidc")
	if operationPath[0] == '/' {
		operationPath = "." + operationPath
	}
...
type ClientWithResponsesInterface interface {
	...
	VolumesListWithResponse(ctx context.Context, appName string, reqEditors ...RequestEditorFn) (*VolumesListResponse, error)
	...
	// MachinesGetOIDCTokenWithBodyWithResponse request with any body
	MachinesGetOIDCTokenWithBodyWithResponse(ctx context.Context, contentType string, body io.Reader, reqEditors ...RequestEditorFn) (*MachinesGetOIDCTokenResponse, error)

	MachinesGetOIDCTokenWithResponse(ctx context.Context, body MachinesGetOIDCTokenJSONRequestBody, reqEditors ...RequestEditorFn) (*MachinesGetOIDCTokenResponse, error)
}
...
type MachinesGetOIDCTokenResponse struct {
	Body         []byte
	HTTPResponse *http.Response
	JSON200      *string
}
...
// Status returns HTTPResponse.Status
func (r MachinesGetOIDCTokenResponse) Status() string {
	if r.HTTPResponse != nil {
		return r.HTTPResponse.Status
	}
	return http.StatusText(0)
...
// StatusCode returns HTTPResponse.StatusCode
func (r MachinesGetOIDCTokenResponse) StatusCode() int {
	if r.HTTPResponse != nil {
		return r.HTTPResponse.StatusCode
	}
	return 0
...
func (c *ClientWithResponses) VolumesListWithResponse(ctx context.Context, appName string, reqEditors ...RequestEditorFn) (*VolumesListResponse, error) {
	rsp, err := c.VolumesList(ctx, appName, reqEditors...)
	if err != nil {
		return nil, err
	}
...
// MachinesGetOIDCTokenWithBodyWithResponse request with arbitrary body returning *MachinesGetOIDCTokenResponse
func (c *ClientWithResponses) MachinesGetOIDCTokenWithBodyWithResponse(ctx context.Context, contentType string, body io.Reader, reqEditors ...RequestEditorFn) (*MachinesGetOIDCTokenResponse, error) {
	rsp, err := c.MachinesGetOIDCTokenWithBody(ctx, contentType, body, reqEditors...)
	if err != nil {
		return nil, err
	}
	return ParseMachinesGetOIDCTokenResponse(rsp)
}

func (c *ClientWithResponses) MachinesGetOIDCTokenWithResponse(ctx context.Context, body MachinesGetOIDCTokenJSONRequestBody, reqEditors ...RequestEditorFn) (*MachinesGetOIDCTokenResponse, error) {
	rsp, err := c.MachinesGetOIDCToken(ctx, body, reqEditors...)
	if err != nil {
		return nil, err
	}
	return ParseMachinesGetOIDCTokenResponse(rsp)
...
// ParseMachinesGetOIDCTokenResponse parses an HTTP response from a MachinesGetOIDCTokenWithResponse call
func ParseMachinesGetOIDCTokenResponse(rsp *http.Response) (*MachinesGetOIDCTokenResponse, error) {
	bodyBytes, err := io.ReadAll(rsp.Body)
	defer func() { _ = rsp.Body.Close() }()
	if err != nil {
		return nil, err
	...
	response := &MachinesGetOIDCTokenResponse{
		Body:         bodyBytes,
		HTTPResponse: rsp,
	}
